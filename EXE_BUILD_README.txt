NETPLUS IPTV PLAYER — v1.6.4 RELIABLE CATALOGUE + PREMIUM UI

This is a complete replacement source package. After installation,
Settings must show “NetPlus IPTV Player v1.6.4”.
...
6. Close the old app and run Netplus-IPTV-Player-Setup-1.6.4.exe. It upgrades
   the previous version; normally you do not need to uninstall first.

TEST AFTER INSTALLATION

1. Open Settings and confirm v1.6.4 Premium UI is shown.
...
5. If any problem remains, choose Settings -> Start fresh test, reproduce one
   Live TV and one VOD attempt, then send netplus-diagnostics-v1.6.4.json.
