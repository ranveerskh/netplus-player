...
4. Your browser opens automatically. On first launch, select Netplus Edge or
   Netplus Classic, then enter the activated MAC address for that service.
...
- Settings shows the active version as NetPlus IPTV Player v1.5.3 Direct VOD + Fast Live Renewal.
- Movies and series are browsed together in Movies & Series; series open as
  seasons, episodes, and provider quality choices.
- The selected Netplus service and MAC address are stored only in config.json
  inside this folder.
