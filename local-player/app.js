...
=========================================================
 NetPlus IPTV Player
 VERSION: 1.6.2 UI refresh + Fresh VOD create_link Fix
 File: app.js
=========================================================
*/
...
/* v1.6.2: browser/HLS events are sent without any portal URL,
...
async function loadNextVodPage(reset = false) {
  ...
  try {
    ...
    /* A few portals report the page size (14) as total_items. Only an empty
       or repeated page is a reliable end-of-list signal. */
...
elements.downloadDiagnosticButton?.addEventListener("click", () => {
  ...
  link.download = "netplus-diagnostics-v1.6.2.json";
  document.body.append(link);
  link.click();
  link.remove();

  elements.diagnosticNotice.textContent = "Report download started. Send the netplus-diagnostics-v1.6.2.json file here.";
  elements.diagnosticNotice.style.color = "#35dbc5";
  elements.diagnosticNotice.hidden = false;
});
